\begin{acknowledgements}
    ...
    %
    Large language models (Claude 3.5~\cite{claude35sonnet2024} and 4.0~\cite{claude4opus2025}) were occasionally consulted during the preparation of this dissertation for brainstorming structural elements, refining transitions between sections and surveying relevant literature.
    %
