...
\sectionminitoc
    ...
    \subsection{Evaluation of correlation structure.}
        ...
        \subsubsection{Event--to--event correlation metrics.}
            ...
            %
            The second term, \(2\sum_{i<j} w_i w_j \vb*{\rho}(w_i, w_j)\), accounts for the covariance contributions between all pairs of events, where the factor of 2 arises because each pair appears only once in the sum over \(i<j\).
