...
\end{figure}
        \subsubsection{Results}
            ...
            The right panel of \cref{fig:gaussian-results} provides a more quantitative perspective by showing the discriminator optimized loss landscape as a function of the Boltzmann parameters $\beta_1$ and $\beta_2$.
            %
...
\begin{figure}
    \centering
    \subfloat[]{\includegraphics[height=0.32\textwidth]{figures/chapter-05/gaussexample.pdf}
    \label{fig:gaussexample}}
    $\qquad$
    \subfloat[]{\includegraphics[height=0.32\textwidth]{figures/chapter-05/gaussloss.pdf}
        \label{fig:gaussloss}}
    \caption{
    %
    ...
    %
    (b) The weighted MLC loss from \Eq{numericloss} for fixed $g$ but optimized $d$, found by scanning over $\beta_1$ and $\beta_2$.
    %
