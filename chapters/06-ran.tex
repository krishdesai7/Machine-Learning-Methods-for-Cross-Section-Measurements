...
\input{tables/6-1.tex}
    ...
    \begin{itemize}
        ...
        \item \textbf{Charge and flavour sensitive observables.}
            ...
            %
            Such observables are often \emph{infrared unsafe} theoretically,\footnote{ecause soft particle emission has no cutoff, perturbative predictions diverge for the distribution shape} meaning theory must rely on phenomenological models.
            %
        ...
        \item \textbf{Multidifferential and high dimensional measurements.}
            ...
            %
            With traditional methods, one would perform a two dimensional unfolding, choosing a projection of \(Q\) if needed (bins in $O$ vs bins in $Q$) to then extract moments or other features as a function of $Q$~\cite{CMS:2011xqa, ATLAS:2010jvh, ATLAS:2020ccu, CMS:2014eaj, ATLAS:2022zbu, D'Agostini:265717}.
            %
