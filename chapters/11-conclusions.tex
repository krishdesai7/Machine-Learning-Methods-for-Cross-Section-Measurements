...
\sectionminitoc
    ...
    \subsection{Impact and Advances}
        ...
        The theoretical understanding of event correlations developed in \cref{chap:unbinned_correlations} is essential for extracting reliable physics parameters from unbinned data and ensuring valid inference.
        %
...
\section{Applications to current and future experiments.}
    ...
    %
    Each method addresses particular needs faced by experiments, as summarised in \cref{tab:method_applications}, and the methods are primed for validation and adoption by the experimental community.
...
\sectionminitoc
    ...
    \subsection{Handling correlations in unbinned inference.}
        ...
        %
        Ignoring these correlations can bias parameter estimates and misestimate confidence intervals, as demonstrated in \cref{chap:unbinned_correlations}.
        %
