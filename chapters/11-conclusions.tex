...
\section{A synthesis of unfolding methods.}
    ...
    \textbf{\textsc{Neural Posterior Unfolding} (NPU)} enhanced traditional binned approaches by replacing point estimates with full posterior distributions, leveraging normalizing flows to capture complex uncertainty structures while maintaining the computational advantages of amortised inference.
    %
...
\sectionminitoc
    ...
    \subsection{Common themes across methods.}
        ...
        %
        In addition to this, the unconstrained generator in a RAN in comparison to the constrained generator of \textsc{Moment Unfolding} requires further regularisation through methods such as spectral normalization or entropy regularisation in order to prevent training instability.
        %
