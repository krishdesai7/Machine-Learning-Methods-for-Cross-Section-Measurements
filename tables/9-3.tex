\begin{longtable}{@{}m{0.19\linewidth}m{0.25\linewidth}m{0.49\linewidth}@{}}
    ...
    \multicolumn{3}{c}{\textit{\cref{tab:detectorSym} continued from previous page}} \\
    \toprule
    \textbf{Symmetry} &
    \textbf{Ideal outcome} &
    \textbf{Detector effect} \\
    ...
    \textbf{Permutation} $(i \leftrightarrow j)$ &
    For identical particles: joint distribution has exchange symmetry &
